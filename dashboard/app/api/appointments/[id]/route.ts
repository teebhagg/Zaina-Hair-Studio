        ...
        if (settings?.googleRefreshToken) {
          ...
          if (appointment.googleEventId) {
            ...
            try {
              ...
              console.log("Google Calendar event updated successfully:", appointment.googleEventId)
            } catch (error: any) {
              ...
              if (error.response?.status === 404) {
                ...
                console.log("Google Calendar event created successfully:", appointment.googleEventId)
              } else {
